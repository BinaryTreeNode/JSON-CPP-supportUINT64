...
Value::asInt() const
{
   ...
   case uintValue:
      ...
      return value_.uint_;
   case uint64Value:
       JSON_ASSERT_MESSAGE( value_.uint64_ < (unsigned)maxInt, "ull out of signed integer range" );
...
Value::asUInt() const
{
   ...
   case uintValue:
      return value_.uint_;
   case uint64Value:
       JSON_ASSERT_MESSAGE( value_.uint64_ >= 0 && value_.uint64_ <= maxUInt, "uint64 can not be converted to unsigned integer"  );
       return value_.uint64_;
   case realValue:
